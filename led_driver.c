...
void Init_Leds(void){
	...
	gpio.GPIO_Pin = GPIO_Pin_12 | GPIO_Pin_13;	//La configuración afecta a los pines 2 y 3
	...
	gpio.GPIO_Pin = GPIO_Pin_14 | GPIO_Pin_15;	//La configuración afecta a los pines 8 y 10
	gpio.GPIO_Mode = GPIO_Mode_OUT;				//Pines como salidas
	gpio.GPIO_OType = GPIO_OType_PP;			//La salida es en modo PushPull
	gpio.GPIO_PuPd = GPIO_PuPd_NOPULL;			//Sin resistencas pull-up ni pull-down
